...
function InboxRowImpl({ role, view, cursor, checked, onCheck, onOpen, onDismiss, onSave, onRestore }: Props) {
  return (
    <li
      ...
      className={`group grid cursor-pointer grid-cols-[1.5rem_1fr] items-center gap-x-2 border-b border-rule px-2 py-2 text-[13px] sm:h-[34px] sm:grid-cols-[1.5rem_2.75rem_minmax(0,1fr)_10rem_5rem_3rem_auto] sm:py-0 ${
